...
def read_eurostat(start = None, output = "output.csv", chunksize = 1):
...
if __name__ == "__main__":
    ...
    # call main function
    read_eurostat(start = args['--start'], output = args['--output'], chunksize = args['--chunksize'])

__all__ = ["read_eurostat"]